...
# User Settings
# ---------------------------
csv_path = '/Users/maycaj/Documents/HSI_III/5-19-25_Round1.csv' # '/Users/maycaj/Documents/HSI_III/Mar10_Noarm.csv' #'/Users/maycaj/Documents/HSI_III/Mar4_1x1_ContinuumRemoved_WLFiltered_Recrop_Gender.csv' 
# csv_path = '/Users/maycaj/Documents/HSI_III/PatchCSVs/DebugData.csv'
...
wavelength_columns = [col for col in df.columns if type(col)]
wavelengths = [float(col.split("_")[1]) for col in wavelength_columns]

# LMpath = '/Users/maycaj/Documents/HSI_III/Absorbances/LM Absorbance.csv'
# convolve_spectra(df, [wavelength_columns[0],wavelength_columns[-1]], 'L','L', LMpath, showFig=False)
# convolve_spectra(df, [wavelength_columns[0],wavelength_columns[-1]], 'M','M', LMpath, showFig=False)
# Spath = '/Users/maycaj/Documents/HSI_III/Absorbances/S Absorbance.csv'
# convolve_spectra(df, [wavelength_columns[0],wavelength_columns[-1]], 'S','S', Spath, showFig=False)

# XYZpath = '/Users/maycaj/Documents/HSI_III/Absorbances/XYZcolorMatchingFunctions.csv'
# convolve_spectra(df, [wavelength_columns[0],wavelength_columns[-1]], 'X','cmfX', XYZpath, showFig=False)
# convolve_spectra(df, [wavelength_columns[0],wavelength_columns[-1]], 'Y','cmfY', XYZpath, showFig=False)
# convolve_spectra(df, [wavelength_columns[0],wavelength_columns[-1]], 'Z','cmfZ', XYZpath, showFig=False)
...
# Convolve the skin spectra with the molecule spectras
WaterPath = '/Users/maycaj/Documents/HSI_III/Absorbances/Water Absorbance.csv'
convolve_spectra(df, [wavelength_columns[0],wavelength_columns[-1]], 'H2O 1/cm','H2O', WaterPath, showFig=False)
...
# highLowPath = '/Users/maycaj/Documents/HSI_III/Absorbances/Low High Abosrbance.csv'
# convolve_spectra(df, [wavelength_columns[0],wavelength_columns[-1]], 'low','low', highLowPath, showFig=False)
# convolve_spectra(df, [wavelength_columns[0],wavelength_columns[-1]], 'high','high', highLowPath, showFig=False)
# convolve_spectra(df, [wavelength_columns[0],wavelength_columns[-1]], 'brightness','brightness', highLowPath, showFig=False)
# fatPath = '/Users/maycaj/Documents/HSI_III/Absorbances/Fat Absorbance.csv'
# convolve_spectra(df, [wavelength_columns[0],wavelength_columns[-1]], 'fat', 'fat', fatPath, showFig=False) # Find Hb for each pixel
